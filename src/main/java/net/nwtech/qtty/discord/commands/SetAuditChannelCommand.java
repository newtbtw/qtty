...
public class SetAuditChannelCommand implements ISlashCommand {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SetAuditChannelCommand.class);
    ...
    public void onCommand(SlashCommandInteractionEvent event) {
        ...
        event.reply("Audit channel updated to " + channel.getName()).setEphemeral(true).queue();
    }
}
